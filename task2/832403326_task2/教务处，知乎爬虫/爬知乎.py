...
web.find_element(By.XPATH,'//*[@id="root"]/div/main/div/div[1]/div/div/div').click()#筛选注意加括号，死几次了

web.implicitly_wait(5)

web.find_element(By.XPATH,'//*[@id="root"]/div/main/div/div[1]/div[2]/ul[1]/li[2]/div').click()#筛选，只看问答



web.find_element(By.XPATH,'//*[@id="SearchMain"]/div/div/div/div[2]/div/div/div/h2/span/div/div/div/a/span')
