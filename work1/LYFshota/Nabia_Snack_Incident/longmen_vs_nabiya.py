...
def display_status(character_name, current_hp, max_hp):
    ...
    # 在这里写你的代码，用print()函数
    print("【",character_name,"】HP: ",current_hp," / ",max_hp)
    pass
    ...
    while nagato_hp > 0 and nabiya_hp > 0:
        ...
        if action == 'attack':
            ...
            if check_critical_hit(base_damage):
                    ...
                    print("长门发动攻击！")
                    nabiya_hp=max(0,nabiya_hp-base_damage+nabiya_defense_bonus)
            ...
            if random.random()<0.5:
                    print("长门发动特殊攻击！")
                    nabiya_hp=max(0,nabiya_hp-SPECIAL_ATTACK_DAMAGE+nabiya_defense_bonus)
            else:
                    print("唔…失手了…长门的特殊攻击未能命中！")
        ...
        if action == 'attack':
            ...
            if check_critical_hit(base_damage):
                    ...
                    print("娜比娅发动攻击！")
                    nagato_hp=max(0,nagato_hp-base_damage+nagato_defense_bonus)
        else:
