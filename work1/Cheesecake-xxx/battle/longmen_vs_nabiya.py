...
def main_battle_loop():
    ...
    while nagato_hp>0 and nabiya_hp>0:
        ...
        if action == 'attack':
            ...
            defend1=calculate_defense_value(3)
        elif action =='special':
            gl=random.randint(0,101)
            if gl>50:
                num3=30
                if defend2 > num3:
                    num = 0
        ...
        # 用 if/elif/else 处理不同行动
        if action == 'attack':
            numm=calculate_attack_damage(4)
            if defend1>numm:
                numm=0
            elif defend2<numm:
                numm-=defend1
            ...
            defend2=calculate_defense_value(3)
        defend1=0
