...
if __name__ == '__main__':
    ...
    argp.add_argument(
        'function', help="Choose pretrain, finetune, or evaluate")
    ...
    print('Model on device: ', next(model.parameters()).device)  # type:ignore
    ...
    if args.function == 'pretrain':
        ...
        trainer_ = trainer.Trainer(
            model, finetune_dataset, None, tconf)
        trainer_.train()
        # type: ignore
        torch.save(model.state_dict(), args.writing_params_path)  # type:ignore
        ### END YOUR CODE ###
