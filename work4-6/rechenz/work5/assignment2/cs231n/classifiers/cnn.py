...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params["W1"] = np.random.normal(
            0.0, weight_scale, (num_filters, input_dim[0], filter_size, filter_size))
        self.params["b1"] = np.zeros((num_filters,))
        self.params["W2"] = np.random.normal(
            0.0, weight_scale, (num_filters * input_dim[1] * input_dim[2] // 4, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        scores, fc_cache = affine_forward(affine_out, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout, dW3, db3 = affine_backward(dscores, fc_cache)
        dconv_out, dW2, db2 = affine_relu_backward(dout, affine_cache)
